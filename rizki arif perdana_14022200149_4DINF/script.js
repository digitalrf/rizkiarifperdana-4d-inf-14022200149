    ...
    $.getJSON(infoURL, function (data) {
      ...
      $(".item-container").prepend(
        "<div class='overview'><div class='movie-container'><div class='movie-inner'><div class='movie-content'><div class='movie-poster'><img class='movie-img' src=" +
          ...
          " / " +
          runtime +
          " min</div></div><h3 class='movie-fields'>Genre</h3><div class='movie-tags'><span class='movie-taxonomy'>" +
          genre +
          "</span></div><h3 class='movie-fields'>Sinopsis</h3><p class='movie-description'>" +
          overview +
          "</p></div><h3 class='movie-fields'>Pemeran</h3><div class='movie-tags'><a class='movie-taxonomy' onclick='showActor(" +
          cast1id +
          ")'>" +
          cast1 +
